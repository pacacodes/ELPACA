      ...
      <Collapse in={opened}>
        <Grid gutter={16}>
          <Grid.Col span={4} style={{ paddingLeft: '23px' }}>
            ...
            <Grid gutter={8} style={{ marginTop: 16, overflowY: 'auto', maxHeight: '720px', width: '100%' }}>
              {Array.from({ length: 12 }).map((_, index) => (
                <Grid.Col span={3} key={index}>
                  <Card shadow="sm" padding="sm" radius={8} withBorder style={{ backgroundColor: 'rgba(200, 200, 200, 0.4)', borderRadius: '8px', width: '160px', height: '240px' }}>
