...
import groundcoverPlants from './plants/groundcover_wiki.json';

function GroundcoverLayer() {
  const [plants, setPlants] = useState([]);
  useEffect(() => {
    setPlants(groundcoverPlants.slice(0, 3));
  }, []);
  return (
    <div style={{ padding: '1rem' }}>
      <h2 style={{ marginBottom: '1rem' }}>Groundcover Layer Example Plants</h2>
...
export default GroundcoverLayer;
