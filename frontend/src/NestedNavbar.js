...
const navSubtitles = [
  ...
  ['Alpaca Service 1', 'Alpaca Service 2'], // Alpaca
...
export default function NestedNavbar({ activeService }) {
  return (
    <Box style={{ position: 'fixed', top: 260, right: 24, width: 320, zIndex: 199, background: 'rgba(0,0,0,0.03)', borderRadius: 8, padding: 16 }}>
      <Stack gap={12}>
