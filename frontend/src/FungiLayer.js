...
import fungiPlants from './plants/fungi_wiki.json';

function FungiLayer() {
  const [plants, setPlants] = useState([]);
  useEffect(() => {
    setPlants(fungiPlants.slice(0, 3));
  }, []);
  return (
    <div style={{ padding: '1rem' }}>
      <h2 style={{ marginBottom: '1rem' }}>Fungi Layer Example Plants</h2>
