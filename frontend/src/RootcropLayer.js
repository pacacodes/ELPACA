...
import rootcropPlants from './plants/rootcrop_wiki.json';

function RootcropLayer() {
  const [plants, setPlants] = useState([]);
  useEffect(() => {
    setPlants(rootcropPlants.slice(0, 3));
  }, []);
  return (
    <div style={{ padding: '1rem' }}>
      <h2 style={{ marginBottom: '1rem' }}>Root Crop Layer Example Plants</h2>
