...
import herbaceousPlants from './plants/herbaceous_wiki.json';

function HerbaceousLayer() {
  const [plants, setPlants] = useState([]);
  useEffect(() => {
    setPlants(herbaceousPlants.slice(0, 3));
  }, []);
  return (
    <div style={{ padding: '1rem' }}>
      <h2 style={{ marginBottom: '1rem' }}>Herbaceous Layer Example Plants</h2>
...
export default HerbaceousLayer;
